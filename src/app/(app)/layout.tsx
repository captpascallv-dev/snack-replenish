...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const displayItems = [...navItems, calendarNavItem, ...(userRole === "OWNER" || userRole === "PARTNER" ? [adminNavItem] : [])];
          ...
          <div>
            ...
            {userName && (
              <button
                ...
                className="text-xs text-zinc-400 mt-0.5 hover:text-brand-green transition-colors flex items-center gap-1"
              >
                <span>{userName} · {roleLabel[userRole] || userRole}</span>
